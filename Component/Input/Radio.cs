...
namespace JGLB.MDUI
{
    ...
    public class Radio<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TValue> : MDUIComponentBase
    {
        /// <summary>
        /// input class
        /// </summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(2, "class", $"mdui-radio {ClassMapper.Class}");
            ...
            builder.AddContent(5, builder2 =>
            {
                ...
                builder2.AddAttribute(2, "type", "radio");
                builder2.AddAttribute(3, "class", $"{InputClass} {Context.FieldClass}");
                builder2.AddAttribute(4, "style", InputStyle);
                builder2.AddAttribute(5, "id", InputId);
                builder.AddAttribute(6, "name", Context.GroupName);
                builder.AddAttribute(7, "value", BindConverter.FormatValue(Value?.ToString()));
                builder.AddAttribute(8, "checked", Context.CurrentValue?.Equals(Value) == true ? GetToggledTrueValue() : null);
                builder.AddAttribute(9, "onchange", Context.ChangeEventCallback);
                builder.SetUpdatesAttributeName("checked");
                builder.AddElementReferenceCapture(10, __inputReference => InputRef = __inputReference);
            ...
            builder.AddContent(6, builder3 =>
            {
                ...
                builder3.AddAttribute(1, "class", "mdui-radio-icon");
